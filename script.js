...
const buttons = {
  prev: document.querySelector(".icon_left"),
  next: document.querySelector(".icon_right"),
};

buttons.next.addEventListener('click', () => reIndex("icon_right"));
buttons.prev.addEventListener('click', () => reIndex("icon_left"));
